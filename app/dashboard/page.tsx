            ...
            {timerLoaded && !teamTimer.startedAt && (
              <div className="absolute inset-0 z-10 flex flex-col items-center justify-center gap-4"
                ...
                <div className="text-center">
                  <p className="text-white font-bold text-lg font-mono">Waiting for facilitator</p>
                  <p className="text-slate-400 text-sm font-mono mt-1">The session hasn't started yet — stand by</p>
                </div>
                <div className="flex items-center gap-2 border border-slate-700 rounded px-4 py-2">
